...
class Empresa(models.Model):
    ...
    nit = models.CharField(verbose_name='Nit', unique=True, null=False, max_length=12, default=000000)
    telefonoPrincipal = models.CharField(verbose_name='Telefono Principal de Empresa', null=False, max_length=12, default=0000000000)
